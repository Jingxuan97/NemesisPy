...
The mol_info dictionary contains information on the molecules recognised
by Nemesis. The molecules are ranked by their Radtran gas identifiers
(see ref_id.py). The following information can be accessed:
    (1) relative terrestrial isotopic abundance for each molecule;
    (2) weight of each isotope in atomic mass unit (amu);
    (3) molecular weight in amu assuming terrestrial isotopic abundance'
...
to access information about the first isotope. Isotopes are ranked by their
relative terrestrial abundance.
...
have set the coeffs. to
(0.0,1.0,0.0,0.0)
and for polyatomic molecules we have set the coeffs to:
(-0.44219E+02, +0.58047E+01, +0.50145E-01, -0.37316E-04)
